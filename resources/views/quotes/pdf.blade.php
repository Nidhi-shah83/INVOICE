    ...
    <body>
        ...
        <div class="header row">
            ...
            <div class="right">
                ...
                <p><strong>Valid Till:</strong> {{ $quote->validity_date?->format('d M, Y') }}</p>
        ...
        <p style="margin: 0;">{{ $quote->client->name }}</p>
        <p style="margin: 2px 0;">{{ $quote->client->address }}</p>
        <p style="margin: 2px 0;">{{ $quote->client->email }}</p>
        <p style="margin: 2px 0 10px;">{{ $quote->client->phone }}</p>
        ...
        <table class="totals">
            <tr>
                <td>Subtotal</td>
                <td style="text-align: right;">{{ $currencySymbol }}{{ number_format($quote->subtotal, 2) }}</td>
            </tr>
            <tr>
                <td>Discount</td>
                <td style="text-align: right;">{{ $currencySymbol }}{{ number_format($quote->discount_amount, 2) }}</td>
            </tr>
            <tr>
                <td>CGST</td>
                <td style="text-align: right;">{{ $currencySymbol }}{{ number_format($quote->cgst, 2) }}</td>
            </tr>
            <tr>
                <td>SGST</td>
                <td style="text-align: right;">{{ $currencySymbol }}{{ number_format($quote->sgst, 2) }}</td>
            </tr>
            <tr>
                <td>IGST</td>
                <td style="text-align: right;">{{ $currencySymbol }}{{ number_format($quote->igst, 2) }}</td>
            </tr>
            <tr>
                <td><strong>Grand Total</strong></td>
                <td style="text-align: right;"><strong>{{ $currencySymbol }}{{ number_format($quote->grand_total, 2) }}</strong></td>
            </tr>
        </table>
    </body>
</html>
