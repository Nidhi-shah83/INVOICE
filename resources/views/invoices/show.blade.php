            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col items-end gap-1">
                        <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold tracking-[0.2em]"
                              :class="paymentBadgeClass()"
                              x-text="paymentStatus.toUpperCase()"
                        ></span>
                        <p x-show="secondaryStatusLabel() !== ''"
                           x-text="secondaryStatusLabel()"
                           class="text-[11px] uppercase tracking-[0.2em] text-slate-400"
                        ></p>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-100 pt-6 space-y-6">
                    ...
                    <div class="space-y-6">
                        <div class="grid gap-6 lg:grid-cols-3 text-sm text-slate-600">
                            <div>
                                <h3 class="text-sm font-semibold text-slate-500">Payment info</h3>
                                <p class="mt-2">Due date: {{ $invoice->due_date?->format('d M, Y') ?? 'N/A' }}</p>
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-slate-500">Reference &amp; meta</h3>
                                <p class="mt-2">Invoice type: {{ ucfirst($invoice->invoice_type) }}</p>
                                <p>PO number: {{ $invoice->po_number ?: 'N/A' }}</p>
                                <p>Reference #: {{ $invoice->reference_no ?: 'N/A' }}</p>
                            </div>
                            <div>
                                <h3 class="text-sm font-semibold text-slate-500">Bank details</h3>
                                <p class="mt-2">Bank: {{ $invoice->bank_name ?: 'N/A' }}</p>
