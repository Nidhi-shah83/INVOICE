    ...
    <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500">Manage customer GST details and states.</p>
            </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($clients as $client)
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3">{{ $client->state }}</td>
                            <td class="px-4 py-3">
                                <span class="inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold {{ $client->gst_type === 'intra' ? 'bg-sky-100 text-sky-700' : 'bg-purple-100 text-purple-700' }}">
